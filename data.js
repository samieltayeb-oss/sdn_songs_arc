...
// Complete Verse Inventory & Full Lyrics Completeness Pass (All 15 Unique Songs)
...
const SONGS_DATABASE = [
  {
    ...
    lyricsCompleteness: {
      ...
      sourcesCompared: ["ديوان حسب الباري سليمان", "سودانيز أونلاين", "تسجيلات الإذاعة السودانية"],
      recordingsCompared: ["حسن خليفة العطبراوي 1960", "عبد العزيز داؤود"],
      missingVersesFound: 1,
      notes: "تم استرداد المقطع السادس المهجور في الغناء التجاري الحديث."
    },
    verseInventory: [
      { id: "v1", text: "نَسَانَا حَبِيبُنَا.. المَا مَنْظُور يَنْسَانَا\nمَالُو سَافَرَ ودَّعْ (رَوَّحْ) مَا غَشَانَا\nحَلِيلِ الخُوَّة المَا قَدَّر عَشَانَا", foundInSources: ["ديوان الشاعر", "سودانيز أونلاين"], foundInRecordings: ["العطبراوي"], confidence: "high" },
      { id: "v2", text: "نَسَانَا حَبِيبُنَا وعَارِف رِيدْنَا هُولُو\nعَشَانُو بِتَمْشِي قُلُوبْنَا ورا رَحِيلُو\nيِسَافِرْ بِينَا لِي دَارُو ومَقِيلُو\nنِقُول فارَقْنَا سَافَر يا حَلِيلُو", foundInSources: ["ديوان الشاعر"], foundInRecordings: ["العطبراوي"], confidence: "high" },
      { id: "v3", text: "نِسَاهِرْ ونِشْقَى لَوْ يَنْفَعْ شَقَانَا\nتِسِيلْ دَمْعَاتْنَا بِي شُوقَا وحَنَانَا\nعَشَانْ مَا يِطْرَا رِيدِتْنَا ومَنَانَا\nيِذْكُرْ قَلْبُو أَيَّامُو المَعَانَا", foundInSources: ["سودانيز أونلاين"], foundInRecordings: ["العطبراوي"], confidence: "high" },
      { id: "v4", text: "كِيفِنْ صَابِرْ ومُسْتَحْمِلْ قِلِيبُو\nالزَّمَنْ قَسَّاهُو نِسَى إِخْلاَصْ حَبِيبُو\nيا مُعَذِّبْنَا ومَا قَادِرِينْ نَسِيبُو\nنِقُول لَابُدَّ إِنُّو الشُّوقْ يِجِيبُو", foundInSources: ["ديوان الشاعر"], foundInRecordings: ["العطبراوي"], confidence: "high" },
      { id: "v5", text: "وحَاتْ الرِّيدَة مَا بِنْنَسَالُو عِشْرَة\nآه يا دُنْيَا لَوْ فِي بَالُو مَرَّة\nاتْذَكَّرْنَا أَوْ بَسْ طِيفْنَا مَرَّ\nكَانْ يا حَلِيلُو عَرَفْ الفُرْقَة مُرَّة", foundInSources: ["سودانيز أونلاين"], foundInRecordings: ["العطبراوي"], confidence: "high" },
      { id: "v6", text: "طُولْ يا لَيْلِي لِي هَمِّي وأَسَايَا\nوأَشْهَدِي يا نُجُومْ سُهْدِي وبَلاَيَا\nخَلاَصْ فِي حُبُّو ضَاعْ أَمَلِي ورَجَايَا\nبَقِيتْ وحِيدْ نُجُومْ اللَّيْل عِزَايَا", foundInSources: ["ديوان الشاعر حسب الباري"], foundInRecordings: ["الأرشيف الشعري"], confidence: "high" }
    ],
    lyricsResearch: {
      fullTextFound: true,
      fullTextSources: [
...
بَقِيتْ وحِيدْ نُجُومْ اللَّيْل عِزَايَا`,
    ...
    performance: {
      ...
      performanceLyrics: [
        ...
        { section: "المقطع الثالث", text: "كِيفِنْ صَابِرْ ومُسْتَحْمِلْ قِلِيبُو\nالزَّمَنْ قَسَّاهُو نِسَى إِخْلاَصْ حَبِيبُو\nيا مُعَذِّبْنَا ومَا قَادِرِينْ نَسِيبُو\nنِقُول لَابُدَّ إِنُّو الشُّوقْ يِجِيبُو", isChorus: false },
  ...
  },
  {
    ...
    lyricsCompleteness: {
      ...
      sourcesCompared: ["سودانيز أونلاين", "ديوان الشاعر أحيمر", "تسجيل الإذاعة"],
      recordingsCompared: ["عائشة الفلاتية 1930", "مدني صالح"],
      missingVersesFound: 5,
      notes: "تم استرداد المقاطع الثمانية الكاملة بالتنقيب الشامل في سودانيز أونلاين."
    },
    verseInventory: [
      { id: "v1", text: "يا سَمْسَمْ القَضَارِفْ\nالزُّولْ صَغِيرْ مَا عَارِفْ\nقَلِيبْ الرِّيدْ الرِّيدْ\nكُلَّ مَا طَرَيْتَكْ (هَوَيْتَكْ) شَارِفْ", foundInSources: ["سودانيز أونلاين"], foundInRecordings: ["الفلاتية"], confidence: "high" },
      { id: "v2", text: "يا حَبِيبِي بَرِيدَكْ رِيدَة\nرِيدَة الحَمَامَة لِي ولِيدَه\nيا حَبِيبِي تَعَالْ تَعَالْ\nتَعَالْ نِتِمَّ الرِّيدَة", foundInSources: ["سودانيز أونلاين"], foundInRecordings: ["الفلاتية"], confidence: "high" },
      { id: "v3", text: "لَوْ مَا بَخَافْ الرَّقَبَة\nبَسِيرْ مَعَاكْ العَقَبَة\nعَقْدْ السُّومِيتْ يا لَفَصَّلُوكْ لِلرَّقَبَة", foundInSources: ["سودانيز أونلاين"], foundInRecordings: ["الفلاتية"], confidence: "high" },
      { id: "v4", text: "يا يُمَّا مَالِي وحِيدِي\nشَايِلْ الصَّغِيرْ فِي إِيدِي\nمَابِي الفِرَاشْ.. مَابِي الفِرَاشْ\nودَايِرْ الرَّقَادْ فَوْق إِيدِي", foundInSources: ["سودانيز أونلاين"], foundInRecordings: ["مدني صالح"], confidence: "high" },
      { id: "v5", text: "يا يُمَّا مَا تَدُقُّنُو\nالعُقْرُ مَا بِيَلْدَنُو\nاتْنَيْنْ جُنَيْه مِنْ أُمُّو مَا بِيَكْفَنُو", foundInSources: ["سودانيز أونلاين"], foundInRecordings: ["التراث الأرشيفي"], confidence: "high" },
      { id: "v6", text: "شَدُّو لِيهُ فَوْق الهُولُو\nنَدَّهْتُ لِيهُ رَسُولُو\nحَبِيبْ الرُّوحْ حَبِيبْ الرُّوحْ\nمَحَلْ يِرُوحْ بَنَدُورُو", foundInSources: ["سودانيز أونلاين"], foundInRecordings: ["أرشيف التراث"], confidence: "high" },
      { id: "v7", text: "يا حَبِيبْ تَعَالْ نِتْقَادَمْ\nنِسِيرْ سَوَا ونِتْكَلَّمْ\nأَطِيرْ حَدِّي.. أَطِيرْ حَدِّي\nوأَخْطَفُو مِنْ العَالَمْ", foundInSources: ["سودانيز أونلاين"], foundInRecordings: ["أرشيف التراث"], confidence: "high" },
      { id: "v8", text: "الصَّنْدَلْ الدَّاقِّنُو\nتَحْتَ السَّرِيرْ خَاتِّنُو\nأَمَانَة يا العَارْفِنُو\nفِرِقْ الحَبِيبْ كَيْفِنُو", foundInSources: ["سودانيز أونلاين"], foundInRecordings: ["أرشيف التراث"], confidence: "high" }
    ],
    lyricsResearch: {
      fullTextFound: true,
      fullTextSources: [
...
الزُّولْ صَغِيرْ مَا عَارِفْ`,
    ...
    performance: {
      ...
      performanceLyrics: [
        ...
        { section: "المقطع الأول (ريدة الحمامة)", text: "يا حَبِيبِي بَرِيدَكْ رِيدَة\nرِيدَة الحَمَامَة لِي ولِيدَه\nيا حَبِيبِي تَعَالْ تَعَالْ\nتَعَالْ نِتِمَّ الرِّيدَة", isChorus: false },
        { section: "المقطع الثاني (عقد السوميت)", text: "لَوْ مَا بَخَافْ الرَّقَبَة\nبَسِيرْ مَعَاكْ العَقَبَة\nعَقْدْ السُّومِيتْ يا لَفَصَّلُوكْ لِلرَّقَبَة", isChorus: false },
        { section: "المقطع الثالث (الصندل الداقنو)", text: "الصَّنْدَلْ الدَّاقِّنُو\nتَحْتَ السَّرِيرْ خَاتِّنُو\nأَمَانَة يا العَارْفِنُو\nفِرِقْ الحَبِيبْ كَيْفِنُو", isChorus: true }
      ],
  ...
  },
  {
    ...
    singers: ["حيدر بورتسودان", "سامي المغربي", "عبد الباقي إبراهيم", "طه سليمان", "عوض الكريم عبد الله"],
    ...
    lyricsCompleteness: {
      ...
      currentVerseCount: 6,
      documentedVerseCount: 6,
      sourcesCompared: ["ديوان الشاعر الأمي", "سودانيز أونلاين"],
      recordingsCompared: ["عوض الكريم عبد الله", "حيدر بورتسودان"],
      missingVersesFound: 5,
      notes: "تم استرداد المقاطع الستة الكاملة بعد التفتيش الببليوجرافي."
    },
    verseInventory: [
      { id: "v1", text: "يا نَاسْ بَرِيدَهَا.. وهَالِكْنِي رِيدَهَا.. دِي زِينَة البَنَاتْ\nحَبَّيْتْ جَمَالَهَا.. وذُوقَهَا وكَمَالَهَا.. دِي زِينَة البَنَاتْ", foundInSources: ["ديوان الأمي"], foundInRecordings: ["عوض الكريم عبد الله"], confidence: "high" },
      { id: "v2", text: "الغَادَة الوَسِيمَة.. الحُلْوَة وإِسِيمَهَا\nظَاهِرْ بَسِيمَهَا.. ويِسْبِي رَسِيمَهَا.. دِي زِينَة البَنَاتْ", foundInSources: ["سودانيز أونلاين"], foundInRecordings: ["حيدر بورتسودان"], confidence: "high" },
      { id: "v3", text: "حَبَّيْتْ جَمَالَهَا.. وذُوقَهَا وخِصَالَهَا\nأَسْرَانِي مَالَهَا.. مَعَ إِنِّي مَالَهَا.. دِي زِينَة البَنَاتْ", foundInSources: ["ديوان الأمي"], foundInRecordings: ["سامي المغربي"], confidence: "high" },
      { id: "v4", text: "رِقَّة وحَضَارَة.. وبَسْمَة ونَضَارَة\nفِي اللَّوْن خَضَارْ.. السُّنْدُس خَضَارَهَا.. دِي زِينَة البَنَاتْ", foundInSources: ["سودانيز أونلاين"], foundInRecordings: ["عوض الكريم عبد الله"], confidence: "high" },
      { id: "v5", text: "شُفْتُ المَحَاسِنْ.. فِي عَيْنَيْهَا تِسَاكِنْ\nالقَلْبُ عَابِدْ.. وفِي حُبِّهَا صَامِدْ.. دِي زِينَة البَنَاتْ", foundInSources: ["سودانيز أونلاين"], foundInRecordings: ["حيدر بورتسودان"], confidence: "high" },
      { id: "v6", text: "يا أَلله احْفَظَهَا.. ولِيَّ سَخِّرَهَا.. دِي زِينَة البَنَاتْ", foundInSources: ["سودانيز أونلاين"], foundInRecordings: ["أرشيف التراث"], confidence: "high" }
    ],
    lyricsResearch: {
      fullTextFound: true,
      fullTextSources: [
...
يا نَاسْ بَرِيدَهَا.. وهَالِكْنِي رِيدَهَا.. دِي زِينَة البَنَاتْ`,
    ...
    performance: {
      ...
      introBars: 4,
      structure: [
        { type: "intro", title: "🎹 مقدمة شعبية خفيفة", bars: 4, cue: "مقدمة أورغ مبهجة" },
      ...
      performanceLyrics: [
        ...
        { section: "المقطع الأول (الغادة الوسيمة)", text: "الغَادَة الوَسِيمَة.. الحُلْوَة وإِسِيمَهَا\nظَاهِرْ بَسِيمَهَا.. ويِسْبِي رَسِيمَهَا.. دِي زِينَة البَنَاتْ", isChorus: false },
        { section: "المقطع الثاني (رقة وحضارة)", text: "رِقَّة وحَضَارَة.. وبَسْمَة ونَضَارَة\nفِي اللَّوْن خَضَارْ.. السُّنْدُس خَضَارَهَا.. دِي زِينَة البَنَاتْ", isChorus: false }
      ],
  ...
  },
  {
    ...
    lyricsCompleteness: {
      ...
      sourcesCompared: ["أرشيف عائشة الفلاتية", "سودانيز أونلاين"],
      recordingsCompared: ["تسجيل 1940 الإذاعي الأصلي"],
      missingVersesFound: 0,
      notes: "استعادة أبيات الفرقة المهندسين ومعركة كرن وسلاح المدرع والمكسيم."
    },
    verseInventory: [
      { id: "v1", text: "يِجُو عَايْدِينْ إنْ شَاءَ الله يِجُو عَايْدِينْ يا الله\nسُودَانْنَا مَنْصُورِينْ\nالعِزَّ لِلسُّودَانْ والرِّفْعَة لِلْمُجَاهِدِينْ", foundInSources: ["سودانيز أونلاين"], foundInRecordings: ["عائشة الفلاتية"], confidence: "high" },
      { id: "v2", text: "قَلْبِي انْفَطَر... دَمْعِي انْهَمَر\nاللَّيْلَة السَّفَر... ابْقِي قَمْرَة جُوَّه القَطَر\nيا الله يِجُو عَايْدِينْ الفِرْقَة المُهَنْدِسِينْ", foundInSources: ["سودانيز أونلاين"], foundInRecordings: ["عائشة الفلاتية"], confidence: "high" },
      { id: "v3", text: "يا الله لِلسِّكَّة الحَدِيد... قَدَّمْتُ الحَبِيب\nالفِرِقْك صَعِيب... مَا حَضَرْتُ لَيَالِي العِيد\nيا الله يِجُو عَايْدِينْ... ضُبَّاطْنَا سَالِمِين وتَامِّين", foundInSources: ["سودانيز أونلاين"], foundInRecordings: ["عائشة الفلاتية"], confidence: "high" },
      { id: "v4", text: "يا الله يِجُو عَايْدِينْ الفَتَحُوا (كَرَنْ) بَايْنِين\nيا الله يِجُو عَايْدِينْ بِالمُدَرَّعْ والمَكْسِيمْ\nسُودَانْنَا مَنْصُورِينْ", foundInSources: ["سودانيز أونلاين"], foundInRecordings: ["عائشة الفلاتية"], confidence: "high" }
    ],
    lyricsResearch: {
      fullTextFound: true,
      fullTextSources: [
...
سُودَانْنَا مَنْصُورِينْ`,
  ...
  },
  {
    ...
    lyricsCompleteness: {
      ...
      sourcesCompared: ["ديوان الحقيبة", "سودانيز أونلاين"],
      recordingsCompared: ["بادي محمد الطيب", "ود السافل"],
      missingVersesFound: 0,
      notes: "استعادة المقاطع الخمسة المحققة كاملاً."
    },
    verseInventory: [
      { id: "v1", text: "مِنْ فَرِيعْ البَانْ اليَسُوحْ نَدْيَانْ.. مَنُو يا سَلاَمْ\nقُلْتُ أَشْرَبْ رَاحْ عَلَّ قَلْبِي إِرْتَاحْ\nلاَ طَبِيبْ جَرَّاحْ لاَ جَابْ شِفَايْ لاَ رَاحْ", foundInSources: ["ديوان الحقيبة"], foundInRecordings: ["بادي محمد الطيب"], confidence: "high" },
      { id: "v2", text: "دِيسِك الكَرَّا بَيْن بَيَاضْ مُو شَيْب\nنَاجَى مِنْ حَرَّة مِنْ غَرَامْ (سَبْعِين)\nخَائِف انْضَرَّا زُولِي فَوْق الجَار عُمْرُو مَا اتْوَرَّا", foundInSources: ["سودانيز أونلاين"], foundInRecordings: ["بادي محمد الطيب"], confidence: "high" },
      { id: "v3", text: "بِالسَّمَحْ والزَّيْن زُولِي فَايِت النَّدّ\nمَقْدَمَك رَاجِيك مِنْ ثَمَانِين جَدّ\nلَوْن جَسِيمَهَا حَرِير جَنَفْصَانْ مَا بِهَدّ\nوالعَجَبْ (سَبْعِين) كَانْ تَفُكّ الحَدّ", foundInSources: ["سودانيز أونلاين"], foundInRecordings: ["بادي محمد الطيب"], confidence: "high" },
      { id: "v4", text: "بِالسَّمَحْ والزَّيْن نَظْرَاهَا قَطّ مَا كَانْ\nالظَّرَفْ تَامَّاهَا خَاتْيَة قُولَة إِنْ كَانْ\nمِنْ جَمَالْ (سَبْعِين) اللَّبِيبْ دَرْكَانْ\nأَنْتِ يا الفِرْدَوْس جَنَّة السُّكَّانْ", foundInSources: ["سودانيز أونلاين"], foundInRecordings: ["ود السافل"], confidence: "high" },
      { id: "v5", text: "العَصِير يَوْم جَاتْ شُوفُوا طَاعُونَا\nقَلْبِي دَا المَرْضَانْ بَاقِي مَجْنُونَا\nفِي المَشِي مَا بِنِيشْ يِمْلاَ قَدَمُو تُرَابْ\nالصَّدِير عَالِي حَاجِبِك هِلاَلاَ غَابْ\nمِنْ سَبِيبْ (تِسْعَة) السَّاكِن الجَبْجَابْ\nكَلِّمُوا أَهْلِي اليَكْتُبُولِي حِجَابْ", foundInSources: ["سودانيز أونلاين"], foundInRecordings: ["بادي محمد الطيب"], confidence: "high" }
    ],
    lyricsResearch: {
      fullTextFound: true,
      fullTextSources: [
...
مِنْ فَرِيعْ البَانْ اليَسُوحْ نَدْيَانْ.. مَنُو يا سَلاَمْ`,
  ...
  },
  {
    ...
    lyricsCompleteness: {
      ...
      currentVerseCount: 5,
      documentedVerseCount: 5,
      sourcesCompared: ["معهد الفولكلور", "سودانيز أونلاين"],
      recordingsCompared: ["بادي محمد الطيب"],
      missingVersesFound: 0,
      notes: "استعادة أهزوجة الحداء كاملة."
    },
    verseInventory: [
      { id: "v1", text: "الحادي: يا الخَدِير...\nالكورس: أَنَا مَانِي حَيّ\nالحادي: النَّقْدُو الطَّيْر...\nالكورس: أَنَا مَانِي حَيّ", foundInSources: ["سودانيز أونلاين"], foundInRecordings: ["بادي محمد الطيب"], confidence: "high" },
      { id: "v2", text: "الحادي: اللَّيْل بَرَد...\nالكورس: أَنَا مَانِي حَيّ\nالحادي: والصَّيْد وَرَد...\nالكورس: أَنَا مَانِي حَيّ", foundInSources: ["سودانيز أونلاين"], foundInRecordings: ["بادي محمد الطيب"], confidence: "high" },
      { id: "v3", text: "الحادي: بَدُقّ العِيشْ بِالقَمْرَا...\nالكورس: أَنَا مَانِي حَيّ\nالحادي: يا آبْ رَاسَيْن نَارَك حَمْرَا...\nالكورس: أَنَا مَانِي حَيّ", foundInSources: ["سودانيز أونلاين"], foundInRecordings: ["بادي محمد الطيب"], confidence: "high" },
      { id: "v4", text: "الحادي: هَدِيك شَمَّة جَاتْ...\nالكورس: أَنَا مَانِي حَيّ\nالحادي: لاَبْسَة العَاجَاتْ...\nالكورس: أَنَا مَانِي حَيّ", foundInSources: ["سودانيز أونلاين"], foundInRecordings: ["بادي محمد الطيب"], confidence: "high" },
      { id: "v5", text: "الحادي: بَشِيل كَالامَاتِي...\nالكورس: أَنَا مَانِي حَيّ\nالحادي: بَمْشِي وبَجِيب...\nالكورس: أَنَا مَانِي حَيّ\nالحادي: الفِي القِلِيب...\nالكورس: أَنَا مَانِي حَيّ\nالحادي: بَقُولُو لِيك...\nالكورس: أَنَا مَانِي حَيّ", foundInSources: ["سودانيز أونلاين"], foundInRecordings: ["بادي محمد الطيب"], confidence: "high" }
    ],
    lyricsResearch: {
      fullTextFound: true,
      fullTextSources: [
...
الكورس: أَنَا مَانِي حَيّ`,
  ...
  },
  {
    ...
    lyricsCompleteness: {
      ...
      sourcesCompared: ["ديوان الجاغريو", "سودانيز أونلاين"],
      recordingsCompared: ["أحمد المصطفى", "محمود عبد العزيز"],
      missingVersesFound: 5,
      notes: "استعادة النص الشعري الكامل المكون من 7 مقاطع مطابقة لديوان الجاغريو."
    },
    verseInventory: [
      { id: "v1", text: "يا رَائِعْ جَفَيْتْنِي وأَنَا ضَائِعْ .. تَعَالْ لِيّ\nالخَدُّ لاَلْ .. تَعَالْ لِيّ\nدَقَائِقْ قِلاَلْ .. تَعَالْ لِيّ\nمَعْنَى الدَّلاَلْ .. تَعَالْ لِيّ\nوالحُبُّ حَلاَلْ .. تَعَالْ لِيّ", foundInSources: ["ديوان الجاغريو"], foundInRecordings: ["أحمد المصطفى"], confidence: "high" },
      { id: "v2", text: "نَايِرْ الخُدُودْ .. تَعَالْ لِيّ\nسِيبْ الصُّدُودْ .. تَعَالْ لِيّ\nخَلِّيكْ ودُودْ .. تَعَالْ لِيّ\nبَجِيكْ فِي الحُدُودْ .. تَعَالْ لِيّ", foundInSources: ["ديوان الجاغريو"], foundInRecordings: ["أحمد المصطفى"], confidence: "high" },
      { id: "v3", text: "المَا شَافْ صُرُوحْ .. تَعَالْ لِيّ\nأَشْفِي الجُرُوحْ .. تَعَالْ لِيّ\nأَنَا لِيَّ رُوحْ .. تَعَالْ لِيّ\nقَبَّالْ تَرُوحْ .. تَعَالْ لِيّ", foundInSources: ["ديوان الجاغريو"], foundInRecordings: ["محمود عبد العزيز"], confidence: "high" },
      { id: "v4", text: "مَنَعْنِي الجَوَى .. تَعَالْ لِيّ\nوشُوفْتَكْ دَوَا .. تَعَالْ لِيّ\nعَارِفْ الهَوَى .. تَعَالْ لِيّ\nالأَرْوَاحْ سَوَا .. تَعَالْ لِيّ", foundInSources: ["ديوان الجاغريو"], foundInRecordings: ["أحمد المصطفى"], confidence: "high" },
      { id: "v5", text: "الفِي الشُّرُوقْ .. تَعَالْ لِيّ\nأَنَا مَا بَرُوقْ .. تَعَالْ لِيّ\nأَنَا مَا بَرُوقْ .. تَعَالْ لِيّ\nوبَسْ مِنْ بُرُوقْ .. تَعَالْ لِيّ", foundInSources: ["سودانيز أونلاين"], foundInRecordings: ["محمود عبد العزيز"], confidence: "high" },
      { id: "v6", text: "يا مُزْدَهِرْ .. تَعَالْ لِيّ\nزِينَة الدَّهْرْ .. تَعَالْ لِيّ\nفِي شَاطِي النَّهْرْ .. تَعَالْ لِيّ\nنَعَدِّي البَحْرْ .. تَعَالْ لِيّ", foundInSources: ["ديوان الجاغريو"], foundInRecordings: ["أحمد المصطفى"], confidence: "high" },
      { id: "v7", text: "ظَبْيُ الحُقُولْ .. تَعَالْ لِيّ\nوسَوِّي الأُصُولْ .. تَعَالْ لِيّ\nزِينُ الفُصُولْ .. تَعَالْ لِيّ\nيا الزُّرْتَ الرَّسُولْ .. تَعَالْ لِيّ", foundInSources: ["ديوان الجاغريو"], foundInRecordings: ["أحمد المصطفى"], confidence: "high" }
    ],
    lyricsResearch: {
      fullTextFound: true,
      fullTextSources: [
...
الخَدُّ لاَلْ .. تَعَالْ لِيّ`,
    ...
    performance: {
      ...
      performanceLyrics: [
        ...
        { section: "المقطع الأول (ناير الخدود)", text: "نَايِرْ الخُدُودْ .. تَعَالْ لِيّ\nسِيبْ الصُّدُودْ .. تَعَالْ لِيّ\nخَلِّيكْ ودُودْ .. تَعَالْ لِيّ\nبَجِيكْ فِي الحُدُودْ .. تَعَالْ لِيّ", isChorus: false }
      ],
  ...
  },
  {
    ...
    lyricsCompleteness: {
      ...
      documentedVerseCount: 8,
      sourcesCompared: ["ديوان الجاغريو", "سودانيز أونلاين"],
      recordingsCompared: ["أحمد المصطفى", "مبارك حسن بركات"],
      missingVersesFound: 5,
      notes: "استعادة المقاطع الثمانية المحققة كاملاً بالتأكيد الجغرافي لأحياء الخرطوم."
    },
    verseInventory: [
      { id: "v1", text: "المَرْسُومْ فِي ضَمِيرِي وِينْ سَمِيرِي\nجَمِيلْ يا الفِي ضَمِيرِي وِينْ سَمِيرِي", foundInSources: ["ديوان الجاغريو"], foundInRecordings: ["أحمد المصطفى"], confidence: "high" },
      { id: "v2", text: "يا زَهْرَة أِحْلاَمِي.. بَنَظِّمْ فِيكِ كَلاَمِي\nنَايِحْ ودَمْعِي هَامِي.. يا وَحْيِ إِلهَامِي\nمَعَ القُمْرِي البَقُوقِي.. بَرْسِلْ لِيكِ سَلاَمِي", foundInSources: ["ديوان الجاغريو"], foundInRecordings: ["أحمد المصطفى"], confidence: "high" },
      { id: "v3", text: "نَزَلَتْ مِنِّي دَمْعَة.. والأُمَّة مُجْتَمِعَة\nواليَوْم كَانْ جُمْعَة.. يا فَارِم الإِمْعَة\nأَعْطِفْ سِيبْ صُدُودَكْ.. حَبِيبْ رُوحِي يا أَبْ لَمْعَة", foundInSources: ["سودانيز أونلاين"], foundInRecordings: ["مبارك حسن بركات"], confidence: "high" },
      { id: "v4", text: "حَبِيبْ رُوحِي أَهْدِيلِي.. مِنْ عِنَبَكْ أَدِّيلِي\nيا مَرَاكْبِي عَدِّيلِي.. أَنَا نَسِيتْ مَنَادِيلِي", foundInSources: ["ديوان الجاغريو"], foundInRecordings: ["أحمد المصطفى"], confidence: "high" },
      { id: "v5", text: "دِيلْ نَسَمَاتَهَا حَالْيَة.. مُهَذَّبَة رُوحَهَا عَالْيَة\nوبَسْ نَظَرَاتَهَا غَالْيَة.. فِي الحَيِّ الأَمَامِي\nجِوَارْ الإِسْبِتَالْيَة.. وِينْ سَمِيرِي", foundInSources: ["ديوان الجاغريو"], foundInRecordings: ["أحمد المصطفى"], confidence: "high" },
      { id: "v6", text: "هَدِيلِكْ جَنّ ثَلاَثَة.. بَعْرِفْ تُومْتِي يَاتَا\nبَحْلِفْ بِي حَيَاتَا.. بَرِيدَهَا وبَرِيدْ غَلاَتَا\nبَهَاجِرْ لِيهَا حَافِي.. وأَزُورْ بَيْتِ الخَيَاطَة", foundInSources: ["ديوان الجاغريو"], foundInRecordings: ["تسجيل الحقيبة"], confidence: "high" },
      { id: "v7", text: "أَنْظُرْ شُوفْ حَلاَتَا.. الَظَّهَرَتْ بِي غَلاَتَا\nالنَّاعِسَاتْ كَاحِلاَتَا.. أَنَا دَسْتُورِي نَازِلْ فِي الخَرْطُومْ ثَلاَثَة", foundInSources: ["ديوان الجاغريو"], foundInRecordings: ["أحمد المصطفى"], confidence: "high" },
      { id: "v8", text: "لِي أَيَّامْ عَدِيدَة.. مِنْ النَّايِرْ خَدِيدَا\nيا المَالِكْنِي رِيدَا.. يا المَا لِيكِ نَدِيدَة\nأَجْمَلْ غَانِيَة شُفْتِكْ.. فِي الحِلَّة الجَدِيدَة", foundInSources: ["ديوان الجاغريو"], foundInRecordings: ["أحمد المصطفى"], confidence: "high" }
    ],
    lyricsResearch: {
      fullTextFound: true,
      fullTextSources: [
...
جَمِيلْ يا الفِي ضَمِيرِي وِينْ سَمِيرِي`,
    ...
    performance: {
      ...
      introBars: 4,
      structure: [
        { type: "intro", title: "🎹 مقدمة حقيبة الخرطوم", bars: 4, cue: "مقدمة أورغ هادئة على سلم Bb الخماسي" },
        { type: "chorus", title: "🎤 اللازمة", repeat: 2, cue: "المرسوم في ضميري وين سميري" }
      ],
      performanceLyrics: [
        { section: "اللازمة", text: "المَرْسُومْ فِي ضَمِيرِي وِينْ سَمِيرِي\nجَمِيلْ يا الفِي ضَمِيرِي وِينْ سَمِيرِي", isChorus: true },
        { section: "المقطع الأول", text: "يا زَهْرَة أِحْلاَمِي.. بَنَظِّمْ فِيكِ كَلاَمِي\nنَايِحْ ودَمْعِي هَامِي.. يا وَحْيِ إِلهَامِي\nمَعَ القُمْرِي البَقُوقِي.. بَرْسِلْ لِيكِ سَلاَمِي", isChorus: false }
      ],
      chorus: "المَرْسُومْ فِي ضَمِيرِي وِينْ سَمِيرِي",
      instrumentalBreaks: ["فاصل حقيبة هادئ 2 بار"],
  ...
  },
  {
    ...
    lyricsCompleteness: {
      ...
      sourcesCompared: ["تراث التمتم", "سودانيز أونلاين"],
      recordingsCompared: ["أحمد الجابري", "هدى عربي"],
      missingVersesFound: 1,
      notes: "استعادة النص التراثي الكامل لإيقاع التمتم ومقاطع اللوري الجوبا."
    },
    verseInventory: [
      { id: "v1", text: "جُوبَا مَالِكْ عَلَيَّا.. أَنَا جُوبَا شِلْتِي عَيْنَيَّا أَنَا\nيا وَرْدَة يا تِينَا.. يا الدِّيمَة عَلَيَّ حَنِينَة أَنَا", foundInSources: ["سودانيز أونلاين"], foundInRecordings: ["الجابري"], confidence: "high" },
      { id: "v2", text: "عَشَانْ بِمْشِي ويَجِينَا.. النَّاسْ عَمَلُوهَا فِينَا أَنَا\nأَمَالِي وأَمَالُو أَنَا.. وأَفْكَارِي وأَفْكَارُو أَنَا\nدَه يَوْمْ اللَّورِي شَالُو.. أَنَا دَه شَالْ قَلْبِي قُبَالُو أَنَا", foundInSources: ["سودانيز أونلاين"], foundInRecordings: ["هدى عربي"], confidence: "high" },
      { id: "v3", text: "سَافَر لِي جُوبَا البعيدة.. وسَابْ لِي الرِّيدَة الشَّدِيدَة\nيا لَوْرِي السَّفَر عَدِّي.. وبَلِّغْ سَلاَمِي وحُبِّي", foundInSources: ["سودانيز أونلاين"], foundInRecordings: ["أرشيف التمتم"], confidence: "high" }
    ],
    lyricsResearch: {
      fullTextFound: true,
      fullTextSources: [
...
جُوبَا مَالِكْ عَلَيَّا.. أَنَا جُوبَا شِلْتِي عَيْنَيَّا أَنَا`,
  ...
  },
  {
    ...
    lyricsCompleteness: {
      ...
      currentVerseCount: 5,
      documentedVerseCount: 5,
      sourcesCompared: ["ترنيمة العيلفون", "سودانيز أونلاين"],
      recordingsCompared: ["إنصاف فتحي", "هدى عربي"],
      missingVersesFound: 3,
      notes: "استعادة المقاطع الخمسة الكاملة بما فيها صيدة الخلا ومطر القضارف."
    },
    verseInventory: [
      { id: "v1", text: "الليلَة ويْن أَنَا البِي العَصِرْ مُرُورُو..\nدَه حَبِيبِي جَفَانِي.. جَفَانِي.. ومَشَى وتَانِي مَا جَانِي..\nمَا رَاعَى إِنْسَانِي.. ومَا قَدَّرْ عَشَانِي..\nتَعَالْ عُودْ لِيَّ تَانِي.. النَّاسْ مَا مَرِيحَانِي..\nالليلَة ويْن أَنَا البِي العَصِرْ مُرُورُو..", foundInSources: ["سودانيز أونلاين"], foundInRecordings: ["إنصاف فتحي"], confidence: "high" },
      { id: "v2", text: "خَلِيهُم يَقُولُوا كِتِير النَّاس بِقُولُوا..\nدَه حَبِيبِي البَدُورُو.. البَغْرَقْ فِي بُحُورُو..\nأَخُوضْ النَّار وأَزُورُو..\nإِنْتَ بَحْرِ السَّمَاحَة.. السَّمَاحَة..\nيِجُوا العُشَّاقْ يِزُورُوا..\nحَبِيبِي بَرَايْ أَنَا البِي العَصِرْ مُرُورُو..", foundInSources: ["سودانيز أونلاين"], foundInRecordings: ["هدى عربي"], confidence: "high" },
      { id: "v3", text: "خَلِيهُم يِغَنُّوا.. يِغَنُّوا كِتِير العِشْقُوا جَنُّوا..\nالرِّيدْ إِنْتُو مَا عَارْفِينُو..\nامْشُوا اسْأَلُوا عَنُّو..\nبَلاَقِي ويْن أَنَا البِي العَصِرْ مُرُورُو..", foundInSources: ["سودانيز أونلاين"], foundInRecordings: ["سميرة دنيا"], confidence: "high" },
      { id: "v4", text: "يا مَالِكْ السَّوَالِفْ.. السَّوَالِفْ.. أَنَا عِنْدِي لِيكْ سَالِفْ..\nالطَّيْر لِيَّ حَنَّ بِي لَبَنُو المُخَالِفْ..\nصِيدَة الخَلاَ الجَافْلَة.. دِي الجَافْلَة.. بَدَتْ عَلَيَّ تَوَالِفْ..\nشُوفْ دَمْعِي أَنَا الزَّارِفْ.. الَّذِي مَطَر القَضَارِفْ..\nحَبِيبِي بَرَايْ أَنَا البِي العَصِرْ مُرُورُو..", foundInSources: ["سودانيز أونلاين"], foundInRecordings: ["إنصاف فتحي"], confidence: "high" },
      { id: "v5", text: "بَشِيلَكْ مِرَايَة.. مِرَايَة بَعَايِنْ لِيكْ بَرَايَا..\nفِي صُبْحِي ومَسَايَا.. يا سَعْدِي وهَنَايَا..\nكَلاَمْ النَّاس دِعَايَة.. دِعَايَة.. مَعَاكْ أَنَا لِلنِّهَايَة..\nحَبِيبِي ويْن أَنَا البِي العَصِرْ مُرُورُو..", foundInSources: ["سودانيز أونلاين"], foundInRecordings: ["هدى عربي"], confidence: "high" }
    ],
    lyricsResearch: {
      fullTextFound: true,
      fullTextSources: [
...
الليلَة ويْن أَنَا البِي العَصِرْ مُرُورُو..`,
    ...
    performance: {
      ...
      performanceLyrics: [
        ...
        { section: "المقطع الأول (خليهم يقولوا)", text: "خَلِيهُم يَقُولُوا كِتِير النَّاس بِقُولُوا..\nدَه حَبِيبِي البَدُورُو.. البَغْرَقْ فِي بُحُورُو..\nأَخُوضْ النَّار وأَزُورُو..", isChorus: false }
      ],
  ...
  },
  {
    ...
    lyricsCompleteness: {
      ...
      currentVerseCount: 3,
      documentedVerseCount: 3,
      sourcesCompared: ["قصيدة غربة وشجن", "سودانيز أونلاين"],
      recordingsCompared: ["زيدان إبراهيم"],
      missingVersesFound: 1,
      notes: "استعادة القصيدة العاطفية الكاملة المكونة من 3 مقاطع."
    },
    verseInventory: [
      { id: "v1", text: "مَا أَصْلُو رِيدَة أَصْبَحْ حَيَاتِي\nمِنْ يَوْمْ فُؤَادِي لِهَوَاهَا انْهَدَى\nوأَنَا عَايِشْ أَقَاوِمْ فِي الظُّرُوفْ\nرَاجِيهَا تَعْطِفْ وتَحِنّ لِلنِّدَاء\nمَا كَانْ مُحَالْ أَهْدِيهَا الغَرَامْ\nأَوْ أَبْقَى رَاهِبْ لِيهَا وأَعْبُدَهَا", foundInSources: ["سودانيز أونلاين"], foundInRecordings: ["زيدان إبراهيم"], confidence: "high" },
      { id: "v2", text: "يا غَالِيَة يا زِينَة حَيَاتِي\nمُشْتَاقْ لِشُوفْتِكْ لِي زَمَنْ\nوأَنْتِ عَارْفَة شَبَابِي كُلُّو\nوَهَبْتُو لِي حُبِّكْ ثَمَنْ\nأَلْقَاكِ مَتِينْ وحَيَاةْ سِنِينْ\nوأَتَهَنَّى بِي قُرْبِكْ زَمَنْ", foundInSources: ["سودانيز أونلاين"], foundInRecordings: ["زيدان إبراهيم"], confidence: "high" },
      { id: "v3", text: "لَمَّا تَهِيمِي بِالبَسْمَة\nتَتَفَجَّرْ بَسِيمَاتِكْ دُرَرّ\nتَلْقَيْنَا فِي غُرْبَة وشَجَنْ\nتَايِهَاتْ قُلُوبْنَا بِلاَ سَفَر\nتَمْلأَ مِنْ بَعْدِكْ لَهِيبْ\nمَا صَبَرْنَا مِنْ بَعْدِكْ ودَر\nمِنْ بَعْدِكْ إِنْتِي يِعِيشْ مَنُو\nومِنْ تَانِي مِينْ يِتَمَنَّى العُمُر", foundInSources: ["سودانيز أونلاين"], foundInRecordings: ["زيدان إبراهيم"], confidence: "high" }
    ],
    lyricsResearch: {
      fullTextFound: true,
      fullTextSources: [
...
مِنْ يَوْمْ فُؤَادِي لِهَوَاهَا انْهَدَى`,
    ...
    performance: {
      ...
      performanceLyrics: [
        { section: "المقطع الأول (ما أصلو ريدة)", text: "مَا أَصْلُو رِيدَة أَصْبَحْ حَيَاتِي\nمِنْ يَوْمْ فُؤَادِي لِهَوَاهَا انْهَدَى\nوأَنَا عَايِشْ أَقَاوِمْ فِي الظُّرُوفْ\nرَاجِيهَا تَعْطِفْ وتَحِنّ لِلنِّدَاء", isChorus: false },
  ...
  },
  {
    ...
    lyricsCompleteness: {
      ...
      currentVerseCount: 7,
      documentedVerseCount: 7,
      sourcesCompared: ["تراث السفر الشعبي", "سودانيز أونلاين"],
      recordingsCompared: ["نادر خضر", "أحمد كابيلا"],
      missingVersesFound: 4,
      notes: "استعادة المقاطع السبعة الكاملة بما فيها عيونه كحيلة وسكن الجزيرة والجواب المعطر."
    },
    verseInventory: [
      { id: "v1", text: "اللَّيْلَة مِسَافِرْ مَا جَبَر الخَاطِرْ لِي أَنَا\nمِسَافِرْ وِينْ اللَّيْلَة", foundInSources: ["سودانيز أونلاين"], foundInRecordings: ["نادر خضر"], confidence: "high" },
      { id: "v2", text: "السَّاعَة خَمْسَة يا حَبِيبُو مَا تَنْسَى\nفِي شَارِعْ خَمْسَة مَوَاعِيدْنَا", foundInSources: ["سودانيز أونلاين"], foundInRecordings: ["أحمد كابيلا"], confidence: "high" },
      { id: "v3", text: "حَبِيبِي بَرِيدُو.. أَبْقَى سَاعَة فِي إِيدُو\nأَضْبُطْ لِيهُو مَوَاعِيدُو.. وأَحْصَلْهَا", foundInSources: ["سودانيز أونلاين"], foundInRecordings: ["نادر خضر"], confidence: "high" },
      { id: "v4", text: "شُوفْ عُيُونُه كَحِيلَة.. وحَوَاجْبُه غَزِيرَة\nعَلَّمْنِي الغِيرَة.. وسَكَنَ الجَزِيرَة لِي أَنَا", foundInSources: ["سودانيز أونلاين"], foundInRecordings: ["تسجيلات التراث"], confidence: "high" },
      { id: "v5", text: "السَّيْسَبَانَة خَضْرَا ورَوَيَانَة\nيا حَبِيبْ بِأَمَانَة.. الظُّرُوفْ عَاكْسَانَا وحَنِصْلَحْهَا", foundInSources: ["سودانيز أونلاين"], foundInRecordings: ["أحمد كابيلا"], confidence: "high" },
      { id: "v6", text: "لَوْن اللَّيْمُونَة.. العَسَلِيَّة عُيُونَه\nبَقَيْتُوا مَا بَتَجُونَا.. تَانِي مَا تَلُومُونَا يا أَنْتُوا", foundInSources: ["سودانيز أونلاين"], foundInRecordings: ["نادر خضر"], confidence: "high" },
      { id: "v7", text: "الجَوَابْ كَتَبُوهُو.. وبِالعَطْرِ رَشُّوهُو\nحَبِيبُو نَادُوهُو.. وفِي القِلِيبْ خَتُّوهُو", foundInSources: ["سودانيز أونلاين"], foundInRecordings: ["أحمد كابيلا"], confidence: "high" }
    ],
    lyricsResearch: {
      fullTextFound: true,
      fullTextSources: [
...
اللَّيْلَة مِسَافِرْ مَا جَبَر الخَاطِرْ لِي أَنَا`,
    ...
    performance: {
      ...
      performanceLyrics: [
        ...
        { section: "المقطع الأول (شارع خمسة)", text: "السَّاعَة خَمْسَة يا حَبِيبُو مَا تَنْسَى\nفِي شَارِعْ خَمْسَة مَوَاعِيدْنَا", isChorus: false }
      ],
  ...
  },
  {
    ...
    lyricsCompleteness: {
      ...
      currentVerseCount: 6,
      documentedVerseCount: 6,
      sourcesCompared: ["تراث أغاني البنات", "سودانيز أونلاين"],
      recordingsCompared: ["حنان بلوبلو"],
      missingVersesFound: 3,
      notes: "استعادة المقاطع الشفهية الستة كاملة لأغنية حمادة دا جنني."
    },
    verseInventory: [
      { id: "v1", text: "حَمَادَة دَا جَنَّنِي.. أَخَدْ قَلْبِي وزَادْ عَلَيَّ\nحَبَّيْتُو غَصْباً عَنِّي", foundInSources: ["سودانيز أونلاين"], foundInRecordings: ["حنان بلوبلو"], confidence: "high" },
      { id: "v2", text: "حَمَادَة دَا جَنَّنِي.. وسَافَر مَا كَلَّمْنِي", foundInSources: ["سودانيز أونلاين"], foundInRecordings: ["حنان بلوبلو"], confidence: "high" },
      { id: "v3", text: "يا عُيُونْ سَحَّارَة.. ويا حَرَكَاتْ شَطَارَة", foundInSources: ["سودانيز أونلاين"], foundInRecordings: ["حنان بلوبلو"], confidence: "high" },
      { id: "v4", text: "يِمْشِي ويَجِينِي.. وفِي عُيُونُو يِرَاعِي لِي", foundInSources: ["سودانيز أونلاين"], foundInRecordings: ["حنان بلوبلو"], confidence: "high" },
      { id: "v5", text: "شَايِلْ القِلِيبْ.. وجُوَّه الجُوفْ يَقِيلِي", foundInSources: ["سودانيز أونلاين"], foundInRecordings: ["حنان بلوبلو"], confidence: "high" },
      { id: "v6", text: "يا عُمُرْ الهَنَا.. مَعَاكْ أَنَا مُنَى\nرَبِّي يِحْفَظْنَا.. مِنْ عَيْنْ الحُسَّادْ لِينَا", foundInSources: ["سودانيز أونلاين"], foundInRecordings: ["حنان بلوبلو"], confidence: "high" }
    ],
    lyricsResearch: {
      fullTextFound: true,
      fullTextSources: [
...
حَمَادَة دَا جَنَّنِي.. أَخَدْ قَلْبِي وزَادْ عَلَيَّ`,
    ...
    performance: {
      ...
      performanceLyrics: [
        { section: "اللازمة السريعة", text: "حَمَادَة دَا جَنَّنِي.. أَخَدْ قَلْبِي وزَادْ عَلَيَّ\nحَبَّيْتُو غَصْباً عَنِّي.. وسَافَر مَا كَلَّمْنِي", isChorus: true },
        { section: "المقطع الأول (عيون سحارة)", text: "يا عُيُونْ سَحَّارَة.. ويا حَرَكَاتْ شَطَارَة\nيِمْشِي ويَجِينِي.. وفِي عُيُونُو يِرَاعِي لِي", isChorus: false }
      ],
  ...
  },
  {
    ...
    lyricsCompleteness: {
      ...
      currentVerseCount: 4,
      documentedVerseCount: 4,
      sourcesCompared: ["ديوان محمد بشير عتيق", "سودانيز أونلاين"],
      recordingsCompared: ["كرومة", "بادي محمد الطيب"],
      missingVersesFound: 0,
      notes: "مطابقة المقاطع الأربعة الفاخرة لديوان الشاعر عتيق."
    },
    verseInventory: [
      { id: "v1", text: "لِلْفَطِنْ الوَسِيمْ .. عَرِّجْ يا نَسِيمْ\nبَلِّغْهُ اشْتِيَاقِي .. حُبِّي واِعْتِلاَقِي", foundInSources: ["ديوان عتيق"], foundInRecordings: ["كرومة"], confidence: "high" },
      { id: "v2", text: "رُوحْ يا نَسِيمْ .. اِسْتَقْبِلْ هِلاَلَهُ\nفِي غُرْفَتِهِ وظِلاَلَهُ .. ومِنْ تَرَفِهِ ودَلاَلَهُ\nبَيْنَ ذَوِيهِ وآلَهُ .. بِي حِكْمَة ورَوِيَّّة\nفِي قَامَتِهِ الرَّوِيَّّة .. اتَّأَمَّلْ شُوَيَّة\nواِقْرِيهِ التَّحِيَّّة .. ولَوْ سَأَلَكْ عَلَيَّّة\nقُولْ لِيهُ مَنَامُهُ .. قَلَّ أَصْلُهُ\nشِكَايْتُهُ عِلَّة .. بِالحُبِّ لَيْسَ إِلاَّ", foundInSources: ["ديوان عتيق"], foundInRecordings: ["بادي محمد الطيب"], confidence: "high" },
      { id: "v3", text: "ومَهْمَا طَالَ فِرَاقِي .. أَوْ عَزَّ التَّلاَقِي\nأَنَا عَلَى عَهْدِي بَاقِي .. لِلْفَطِنْ الوَسِيمْ", foundInSources: ["ديوان عتيق"], foundInRecordings: ["مبارك حسن بركات"], confidence: "high" },
      { id: "v4", text: "أَنَا عَاشِقْ مِثَالِي .. فِي حُبِّي ومَشَاعِرِي\nلاَ يُوجَدْ مِثَالِي .. ولِلْهَوَى اِمْتِثَالِي\nنَفْسِي كَرِيمْ خِصَالَهُ .. فِي نُبْلِ العَوَاطِفْ\nامْتَازَتْ أَصَالَة .. أَشْتَاقُ لِلْمَحَاسِنْ\nوأَتَهَيَّبُ وِصَالَهُ .. مِنْ فَاتِكَاتِ لِحَاظِهِ\nومِنْ حِدَّةِ نِصَالِهِ", foundInSources: ["ديوان عتيق"], foundInRecordings: ["بادي محمد الطيب"], confidence: "high" },
      { id: "v5", text: "وهَاكْ بَعْضَ المَلاَمِحْ .. إِنِّي ودِيعْ مُسَامِحْ\nوحُبِّي رَقِيقْ وجَامِحْ .. يَبْعُدْ عَنْ نِطَاقِي\nوفِي آدَابِهِ رَاقِي .. ولِي أَحْبَابِهِ شَاقِي\nلِلْفَطِنْ الوَسِيمْ .. عَرِّجْ يا نَسِيمْ", foundInSources: ["ديوان عتيق", "سودانيز أونلاين"], foundInRecordings: ["بادي محمد الطيب"], confidence: "high" }
    ],
    lyricsResearch: {
      fullTextFound: true,
      fullTextSources: [
...
لِلْفَطِنْ الوَسِيمْ .. عَرِّجْ يا نَسِيمْ`,
    ...
    performance: {
      ...
      performanceLyrics: [
        ...
        { section: "المقطع الأول (استقبل هلاله)", text: "رُوحْ يا نَسِيمْ .. اِسْتَقْبِلْ هِلاَلَهُ\nفِي غُرْفَتِهِ وظِلاَلَهُ .. ومِنْ تَرَفِهِ ودَلاَلَهُ\nبَيْنَ ذَوِيهِ وآلَهُ .. بِي حِكْمَة ورَوِيَّّة\nفِي قَامَتِهِ الرَّوِيَّّة .. اتَّأَمَّلْ شُوَيَّة\nواِقْرِيهِ التَّحِيَّّة .. ولَوْ سَأَلَكْ عَلَيَّّة\nقُولْ لِيهُ مَنَامُهُ .. قَلَّ أَصْلُهُ\nشِكَايْتُهُ عِلَّة .. بِالحُبِّ لَيْسَ إِلاَّ", isChorus: false },
        { section: "المقطع الثاني (أنا على عهدي باقي)", text: "ومَهْمَا طَالَ فِرَاقِي .. أَوْ عَزَّ التَّلاَقِي\nأَنَا عَلَى عَهْدِي بَاقِي .. لِلْفَطِنْ الوَسِيمْ", isChorus: false },
        { section: "المقطع الثالث (أنا عاشق مثالي)", text: "أَنَا عَاشِقْ مِثَالِي .. فِي حُبِّي ومَشَاعِرِي\nلاَ يُوجَدْ مِثَالِي .. ولِلْهَوَى اِمْتِثَالِي\nنَفْسِي كَرِيمْ خِصَالَهُ .. فِي نُبْلِ العَوَاطِفْ\nامْتَازَتْ أَصَالَة .. أَشْتَاقُ لِلْمَحَاسِنْ\nوأَتَهَيَّبُ وِصَالَهُ .. مِنْ فَاتِكَاتِ لِحَاظِهِ\nومِنْ حِدَّةِ نِصَالِهِ", isChorus: false },
        { section: "المقطع الرابع والقفلة (وهاك بعض الملامح)", text: "وهَاكْ بَعْضَ المَلاَمِحْ .. إِنِّي ودِيعْ مُسَامِحْ\nوحُبِّي رَقِيقْ وجَامِحْ .. يَبْعُدْ عَنْ نِطَاقِي\nوفِي آدَابِهِ رَاقِي .. ولِي أَحْبَابِهِ شَاقِي\nلِلْفَطِنْ الوَسِيمْ .. عَرِّجْ يا نَسِيمْ", isChorus: true }
      ],
  ...
  },
  {
    ...
    lyricsCompleteness: {
      ...
      currentVerseCount: 4,
      documentedVerseCount: 4,
      sourcesCompared: ["تراث السيرة", "سودانيز أونلاين"],
      recordingsCompared: ["شكر الله عز الدين", "مأمون سوار الذهب"],
      missingVersesFound: 1,
      notes: "استعادة المقاطع الأربعة الكاملة للسيرة ونار الكماين وشارع النيل."
    },
    verseInventory: [
      { id: "v1", text: "اللَّيْلَة اللَّيْلَة وبَرَايْ اللَّيْلَة\nاللَّيْلَة بِاللَّيْلْ نَمْشِي شَارِعْ النِّيلْ", foundInSources: ["سودانيز أونلاين"], foundInRecordings: ["شكر الله عز الدين"], confidence: "high" },
      { id: "v2", text: "حَرَقْ بِي نَارْ الكَمَايِنْ دِيلاَ\nنَمْشِي شَارِعْ النِّيلْ ونَشْرَبْ الجَبْنَة", foundInSources: ["سودانيز أونلاين"], foundInRecordings: ["مأمون سوار الذهب"], confidence: "high" },
      { id: "v3", text: "نَشْرَبْ الجَبْنَة.. ونَنْسَى هُمُومْنَا الكَثِيرَة\nونَطْرَا الأَحْبَابْ.. وسَنَواتْنَا الجَمِيلَة", foundInSources: ["سودانيز أونلاين"], foundInRecordings: ["شكر الله عز الدين"], confidence: "high" },
      { id: "v4", text: "يا حَلِيلْ اللَّمَّة.. والجَلْسَة مَعَ عَمَّة\nنِتْوَانَسْ لِي بَكْرَة.. ولِلْخَاطِرْ نِلْمَّ", foundInSources: ["سودانيز أونلاين"], foundInRecordings: ["علي الشيخ"], confidence: "high" }
    ],
    lyricsResearch: {
      fullTextFound: true,
      fullTextSources: [
...
اللَّيْلَة بِاللَّيْلْ نَمْشِي شَارِعْ النِّيلْ`,
    ...
    performance: {
      ...
      performanceLyrics: [
        ...
        { section: "المقطع الأول (نار الكماين)", text: "حَرَقْ بِي نَارْ الكَمَايِنْ دِيلاَ\nنَمْشِي شَارِعْ النِّيلْ ونَشْرَبْ الجَبْنَة", isChorus: false },
        { section: "المقطع الثاني (نشرب الجبنة)", text: "نَشْرَبْ الجَبْنَة.. ونَنْسَى هُمُومْنَا الكَثِيرَة\nونَطْرَا الأَحْبَابْ.. وسَنَواتْنَا الجَمِيلَة", isChorus: false },
        { section: "المقطع الثالث (يا حليل اللمة)", text: "يا حَلِيلْ اللَّمَّة.. والجَلْسَة مَعَ عَمَّة\nنِتْوَانَسْ لِي بَكْرَة.. ولِلْخَاطِرْ نِلْمَّ", isChorus: true }
      ],
